    ...
    constructor(props) {
        ...
        _defineProperty(this, "updateUserMessages",
            ...
            newMessage => {
                ...
                for (let botMessage of botResponses) {
                    updatedBotMessages = updatedBotMessages.concat(botMessage);
                }
        ...
        _defineProperty(this, "showMessages",
            ...
            () => {
                ...
                for (; i < userMessages.length; i++) {
                    ...
                    if (botMessages[i]) {
                        allMessages.push( /*#__PURE__*/React.createElement(BotBubble, { message: botMessages[i], thisRef: this.scrollBubble }));
                    }
                }

                allMessages.unshift( /*#__PURE__*/React.createElement(BotBubble, {
                    message: this.state.botGreeting,
                    thisRef: i === 0 ? this.scrollBubble : ""
                }));

                return /*#__PURE__*/React.createElement("div", { className: "msg-container", ref: (el) => { this.messagesEnd = el; } }, allMessages);
            });
        ...
        return /*#__PURE__*/(
            React.createElement("div", { className: "app-container" }, /*#__PURE__*/
                ...
                React.createElement("div", { className: "chat-container" }, /*#__PURE__*/
                    ...
                    React.createElement("div", { ref: (el) => { this.messagesEnd = el; } })))
        );
...
class BotBubble extends React.Component {
    render() {
        return /*#__PURE__*/(
            React.createElement("div", { className: "bot-message-container" }, /*#__PURE__*/
                React.createElement("img", { src: "head.jpg", alt: "Bot Avatar", className: "bot-avatar" }), /*#__PURE__*/
...
style.textContent = `
    ...
    .user-message-container .chat-bubble {
        background-color: #e6e6e6;
        align-self: flex-end;
    }

    .bot-message-container .chat-bubble {
